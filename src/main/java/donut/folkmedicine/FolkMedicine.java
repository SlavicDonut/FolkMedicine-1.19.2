...
import donut.folkmedicine.init.ModVanillaCompatibility;
...
import donut.folkmedicine.world.level.feature.ModPlacedFeatures;
...
public class FolkMedicine
{
    ...
    {
        event.enqueueWork(() -> ModVanillaCompatibility.init());
    }
